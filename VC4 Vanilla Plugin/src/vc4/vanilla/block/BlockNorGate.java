...
public class BlockNorGate extends BlockLogicGate implements IBlockWrenchable{
	...
	public int getTextureIndexGate(World world, long x, long y, long z, int side) {
		...
		if(side1[data] == side) return BlockTexture.norGateInputA;
		if(side2[data] == side) return BlockTexture.norGateInputB;
		return BlockTexture.norGateOutput;
	}
