...
public class BlockRepeaterGate extends BlockLogicGate implements IBlockWrenchable {

	public BlockRepeaterGate(int uid) {
		super(uid);
	}
	...
	public int getTextureIndexGate(World world, long x, long y, long z, int side) {
		...
		if (side == data) return BlockTexture.repeaterGateInput;
		return BlockTexture.repeaterGateOutput;
	}
