...
public class AIFreeNPCs extends AI {
	...
	public boolean update() {
		...
		// owner.jump();
		// } else{
		// AABB[] nb = owner.world.getBlockType(MathUtils.floor(owner.position.x), MathUtils.floor(owner.bounds.minY - 0.2D), MathUtils.floor(owner.position.z)).getCollisionBounds(owner.world, MathUtils.floor(owner.position.x),
		// MathUtils.floor(owner.bounds.minY - 0.2D), MathUtils.floor(owner.position.z));
