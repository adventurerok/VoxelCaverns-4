...
public class RecursiveGenCaves extends RecursiveGenerator {
	...
	public void generateCaveNode(Random rand, long x, long y, long z, long cx, long cy, long cz, GeneratorOutput data, double sx, double sy, double sz, float yaw, float pitch, float stride, int length, int radius) {
