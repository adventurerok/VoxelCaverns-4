 ...
 * <p>
 * The parser and the scanner form together the 'Parse' step in the loading process (see chapter 3.1 of the <a href="http://yaml.org/spec/1.1/">YAML Specification</a>).
 * </p>
 * 
...
public interface Scanner {
	 ...
	 * @param choices
	 *            token IDs.
	 * @return <code>true</code> if the next token can be assigned to a variable of at least one of the given types. Returns <code>false</code> if no more tokens are available.
