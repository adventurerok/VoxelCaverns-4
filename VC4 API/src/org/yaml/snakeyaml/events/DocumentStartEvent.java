...
public final class DocumentStartEvent extends Event {
	 ...
	 * 
	 * @return <code>null</code>if the document has no explicit <code>%YAML</code> directive. Otherwise an array with two components, the major and minor part of the version (in this order).
	 */
