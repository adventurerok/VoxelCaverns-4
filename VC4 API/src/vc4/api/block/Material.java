...
public class Material {
	...
	/**
	 * Sets the attributes for the time to destroy a block and the blast resistance of the block. Attributes are options that define the default settings of a block of the material.
	 * 
	 * @param destroyTime
	 *            The time it takes for a player to destroy this block, in seconds
	 * @param blastResistance
	 *            The resistance of the blast. 1 would be typical
