...
public abstract class Audio {
	 ...
	 * 
	 * @param audio
	 *            The new audio implementation for the api to use
	 */
	 ...
	 * 
	 * @param path
	 *            The path within the /sound/ directory of the resourcedir
	 * @throws IOException
	 ...
	 * 
	 * @param path
	 *            The path within the /music/ directory of the resourcedir
	 * @throws IOException
	 *             If there is an io error
	 */
	 ...
	 * 
	 * @param name
	 *            The resourcedir path of the music track to play
	 */
	...
	/**
	 * Plays a music object on the client. The music will only play if it has the highest priority.
	 * 
	 * @param music
	 ...
	 * 
	 * @param name
	 *            The resourcedir path of the sound effect to play
	 * @param volume
