...
public class CraftingRecipe {
	...
	/*
	 * Checks if the recipie can be crafted Please use Arrays.sort(input) before using this or else it won't work
	 * 
	...
	public boolean canCraftNow(ItemStack[] input, short[] item) {
		inputData = -1;
		if (input.length != itemInput.length) { return false; }
