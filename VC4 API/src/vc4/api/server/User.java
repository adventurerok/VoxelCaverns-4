...
public interface User {
	...
	/**
	 * Gets the capabilities level of the user
	 * 100 is if the user has console capabilities
	 * 010 is if the user has player capabilities
	 * 001 is if the user has user capabilies
	 * 11 is all
	 * 
