...
public class MidiChannel implements MetaEventListener {
	 ...
	 * 
	 * @param filename
	 *            Filename or identifier of a MIDI sequence to remove from the queue.
	 */
	...
	/**
	 * Fades out the volume of whatever sequence is currently playing, then begins playing the specified MIDI file at the previously assigned volume level. If the filenameURL parameter is null or empty, playback will simply fade out and
	 * stop. The miliseconds parameter must be non-negative or zero. This method will remove anything that is currently in the list of queued MIDI sequences that would have played next when current playback finished.
	 * 
	 * @param filenameURL
	...
	/**
	 * Fades out the volume of whatever sequence is currently playing, then fades the volume back in playing the specified MIDI file. Final volume after fade-in completes will be equal to the previously assigned volume level. The
	 * filenameURL parameter may not be null or empty. The miliseconds parameters must be non-negative or zero. This method will remove anything that is currently in the list of queued MIDI sequences that would have played next when current
	 * playback finished.
	 * 
	 * @param filenameURL
	 *            MIDI file to play next, or null for none.
	...
	/**
	 * Changes the basic information about the MIDI source. This method removes any queued filenames/URLs from the list of MIDI sequences that would have played after the current sequence ended. The fourth parameter, 'identifier' should
	 ...
	 *            GET or SET.
	 * @param value
	 *            New value if action == SET, or YYY if action == GET.
	 * @return True while looping.
	 */
	...
	/**
	 * First attempts to load the specified "override MIDI synthesizer" if one was defined. If none was defined or unable to use it, then attempts to load the default synthesizer. If that fails, then other common synthesizers are attempted.
	 * If none can be loaded, then MIDI is not possible on this system.
	 */
