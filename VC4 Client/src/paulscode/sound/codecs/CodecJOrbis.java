...
/**
 * The CodecJOrbis class provides an ICodec interface to the external JOrbis library. <b><i> SoundSystem CodecJOrbis Class License:</b></i><br>
 * <b><br>
...
public class CodecJOrbis implements ICodec {
	...
	public SoundBuffer read() {
		...
		while (!endOfStream(GET, YYY) && (returnBuffer == null || returnBuffer.length < SoundSystemConfig.getStreamingBufferSize())) {
	...
	private byte[] readBytes() {
		if (!initialized(GET, YYY)) return null;

		if (endOfStream(GET, YYY)) return null;
	 ...
	 * @return New array.
	 */
	public static byte[] trimArray(byte[] array, int maxLength) {
