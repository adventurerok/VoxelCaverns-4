...
/**
 * The StreamThread class is used to process all streaming sources. This thread starts out asleep, and it sleeps when all streaming sources are finished playing, so it is necessary to call interrupt() after adding new streaming sources to
 * the list. <br>
 * <br>
...
public class StreamThread extends SimpleThread {
	 ...
	 */
	public boolean errorCheck(boolean error, String message) {
