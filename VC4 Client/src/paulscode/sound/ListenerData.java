...
/**
 * The listenerData class is used to store information about the listener's position and orientation. A ListenerData object can be obtained using SoundSystem's getListenerData() method. See {@link paulscode.sound.Vector3D Vector3D} for more
 * information about 3D coordinates and vectors. <br>
 * <br>
...
public class ListenerData {
	 ...
	 * @param a
	 *            Angle in radians that the listener is turned counterclockwise around the y-axis.
	 */
	 ...
	 * @param l
	 *            Normalized vector indicating the direction which the listener is facing.
	 * @param u
