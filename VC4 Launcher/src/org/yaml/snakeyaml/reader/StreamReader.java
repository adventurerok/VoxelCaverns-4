...
public class StreamReader {
	...
	public String prefix(int length) {
		...
		if (this.pointer + length > this.buffer.length()) { return this.buffer.substring(this.pointer); }
	...
	private void update() {
		if (!this.eof) {
			...
			try {
				...
				if (converted > 0) {
					/*
					 * Let's create StringBuilder manually. Anyway str1 + str2 generates new StringBuilder(str1).append(str2).toSting() Giving correct capacity to the constructor prevents unnecessary operations in appends.
					 */
